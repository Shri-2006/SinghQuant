...
from core.config import RISKY1_ASSETS, MAX_POSITION_SIZE, CAPITAL, POLYGON_API_KEY_RISKY1
...
def trade_ticker(api, ticker, multiplier=1.0, vix=None):
    ...
    df = get_latest_bar(ticker, api_key=POLYGON_API_KEY_RISKY1)
...
def run():
    """
    Main loop for risky1 momentum strategy.
    ...
    while True:
        try:
            ...
            print("Risky1 bot manually stopped")
            break
        except Exception as e:
